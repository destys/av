...
export default function PriceListItem({ item, params }) {
  ...
  return (
    <button
      ...
      className="flex items-center gap-2.5 md:gap-space-large p-[15px] md:p-x-large md:py-5 xl:p-large bg-navy-100 rounded-2xl xs:rounded-large border border-transparent hover:border-navy text-left"
    >
